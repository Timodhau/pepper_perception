...
class LaserPublisher(object):
    def __init__(self):
        ...
        # Subscribers
        left_sub = Subscriber('/laser/srd_left/scan', LaserScan)
        front_sub = Subscriber('/laser/srd_front/scan', LaserScan)
        right_sub = Subscriber('/laser/srd_right/scan', LaserScan)

        # self.ts = TimeSynchronizer([left_sub, front_sub, right_sub], 10)
        self.ts = ApproximateTimeSynchronizer([left_sub, front_sub, right_sub], 10, 0.1)
